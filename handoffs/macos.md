...
- 实现提交：`26c1e93`；评审修复提交：`a6aeb21054a0bd599c79d42c80529028c61af757`、`9ccf84708ab67e1c6d6171094d312c31465af8b9`、`7581b05e1f2bf4242c498ecd81414abeaf6d225c`
- 当前已验证实现 HEAD：`7581b05e1f2bf4242c498ecd81414abeaf6d225c`
...
- USB 学习在点击开始时固定 profile ID，并将该 ID 贯穿设备回调和候选选择；切换当前编辑配置不会改变目标，目标被删除时丢弃迟到结果。学习超时为提案规定的 30 秒；学习期间暂停自动网络交接、USB 触发、DDC 和唤醒，取消或超时保留原绑定并丢弃迟到结果。
