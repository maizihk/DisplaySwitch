...
| 2026-08-29 | DS-009 Apple Silicon 原生显示控制 | 自动验证完成，实机待验 | 本任务提交 | 76 项 XCTest、Debug/Release、打包和严格验签；读取门控、映射幂等、Type-C 双写、M4 chip/offset 分离、有限读取策略回退和详细诊断回归通过，真实原生 DDC 未执行 |
