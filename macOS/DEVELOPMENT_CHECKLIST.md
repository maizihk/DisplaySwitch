...
| 2026-08-31 | DS-025 USB 与协同设置布局对齐 | 自动验证完成，GUI 待验 | 6181b2a、10a3aa9、c08bcbb、3d42c4d | USB/协同各收敛为三组可滚动内容；修复尾部对齐、卡片深浅色层级/圆角、普通按钮样式和双背景画布根因；22 项展示/AppKit 测试、完整 168 项 XCTest、Release 构建和严格验签通过；真实 GUI/辅助功能待验 |
