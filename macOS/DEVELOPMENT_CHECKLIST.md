...
- [x] USB 学习开始时固定目标配置 ID；回调、候选选择、取消和超时不读取当前选择，目标被删除时丢弃迟到结果。
...
| 2026-08-27 | M-004B DS-004 本机多协同配置模型 | 自动验证完成，实机待验 | 26c1e93、a6aeb21、9ccf847 | 27 项配置测试、40 项全部 XCTest、Debug/Release、打包与严格验签通过；PR #20 当前实现 CI 通过 |
