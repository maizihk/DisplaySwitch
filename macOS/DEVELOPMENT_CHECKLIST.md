...
| 2026-08-30 | M-006 诊断与脱敏 | 自动验证完成，诊断状态修复待复验 | 21dcbe3、9c09212、7e56bf6 | 首版实机发现逐台 DDC 读取时全量重新枚举会清空前两台最后结果；现仅在 selector、service identity 或传输变化时重置。PR #59 CI run 33316060868 完成 149 项 XCTest、Release 打包、严格验签和 artifact 上传 |
