...
| 2026-08-30 | M-006 诊断与脱敏 | 自动验证完成，GUI 待验 | 21dcbe3 | 诊断页统一预览版本、协议、协同、USB、显示器与 DDC 状态；菜单不再直接复制；匿名 P/D/S/O 标识及私密配置排除测试通过；PR #59 CI run 33314381545 完成 146 项 XCTest、Release 打包、严格验签和 artifact 上传 |
