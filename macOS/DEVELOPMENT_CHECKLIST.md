...
- [x] 设置页提供多配置管理和零副作用本机检测；菜单只按已开启配置显示自定义“切换到…”入口，不再显示“切换到本机”。
...
| 2026-08-27 | M-004B DS-004 本机多协同配置模型 | 自动验证完成，实机待验 | 26c1e93 | 19 项配置测试、32 项全部 XCTest、Debug/Release、打包与严格验签通过 |
