...
- [x] 17 项设置展示模型测试和完整 163 项 XCTest 通过；Release `build-app.sh` 与严格 codesign 验证通过。
...
| 2026-08-31 | DS-025 USB 与协同设置布局对齐 | 自动验证完成，GUI 待验 | 6181b2a | USB/协同各收敛为三组可滚动内容；17 项展示模型测试、完整 163 项 XCTest、Release 构建和严格验签通过；即时保存、协议和硬件行为未变，真实 GUI/辅助功能待验 |
