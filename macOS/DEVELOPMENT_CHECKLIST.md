...
| 2026-08-31 | DS-025 USB 与协同设置布局对齐 | 自动验证完成，GUI 待验 | 6181b2a、10a3aa9、c08bcbb | USB/协同各收敛为三组可滚动内容；修复尾部对齐、卡片深浅色层级/圆角及普通按钮样式根因；20 项展示/AppKit 测试、完整 166 项 XCTest、Release 构建和严格验签通过；真实 GUI/辅助功能待验 |
