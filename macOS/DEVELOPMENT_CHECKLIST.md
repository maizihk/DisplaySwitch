...
| 2026-08-31 | DS-025 USB 与协同设置布局对齐 | 自动验证完成，GUI 待验 | 6181b2a、本次修复提交 | USB/协同各收敛为三组可滚动内容；修复尾部控件挤在左侧的 stack distribution 根因；18 项展示模型测试、完整 164 项 XCTest、Release 构建和严格验签通过；真实 GUI/辅助功能待验 |
